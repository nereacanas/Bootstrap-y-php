        ...
        <div class="container">
            <section id="content">
                <form action="<?php echo base_url()."index.php/User/modify"; ?>" method="post">
                    ...
                    <div>
                        <input type="text" value="<?php echo $this->session->userdata('username'); ?>" id="username" name="username" readonly/>
                    </div>
                    <div>
                        <input type="password" placeholder="Contraseña actual" required="" id="password" name="password" />
                    </div>
                    <div>
                        <input type="password" placeholder="Nueva contraseña" required="" id="password_renew" name="password_renew" minlength="6" />
                    </div>
                    <div>
                        <input type="password" placeholder="Repita la contraseña" required="" id="password_repeat" name="password_repeat" />
                    </div>
                    <div>

    ...
    <div class="container">
      <div class="main-titles-head ">
        <h3 class="header-name ">
          ¿Qué tipo de receta quieres para hoy?
        </h3>
      </div>
      <div class="gallery-image row">
        <div class="img-box col-lg-4 col-md-6 col-sm-6">
          <img src="<?php echo base_url()."assets/images/b2.jpg"; ?>" alt="product" class="img-responsive ">
          <h5 class="my-2"><a href="<?php echo base_url()."index.php/Receipe/tradicionales"; ?>">Recetas tradicionales</a></h5>
        </div>
        <div class="img-box col-lg-4 col-md-6 col-sm-6">
          <img src="<?php echo base_url()."assets/images/b1.jpg"; ?>" alt="product" class="img-responsive ">
          <h5 class="my-2"><a href="<?php echo base_url()."index.php/Receipe/slowfood"; ?>">Recetas Slow Food</a></h5>
        </div>
        <div class="img-box col-lg-4 col-md-6 col-sm-6">
          <img src="<?php echo base_url()."assets/images/b3.jpg"; ?>" alt="product" class="img-responsive ">
          <h5 class="my-2"><a href="<?php echo base_url()."index.php/Receipe/sinaceite"; ?>">Recetas de freidoras sin aceite</a></h5>
        </div>
      </div>
    </div>
  </div>

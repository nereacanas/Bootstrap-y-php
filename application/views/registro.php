        ...
        <div class="container">
            <section id="content">
                <form action="<?php echo base_url()."index.php/User/registrar"; ?>" method="post">
                    ...
                    <div>
                        <input type="password" placeholder="Contraseña" required="" id="password" minlength="6" name="password" />
                    </div>
                    <div>
                        <input type="text" placeholder="Nombre" required="" id="nombre" name="nombre" />
                    </div>
                    <div>
                        <input type="text" placeholder="Primer apellido" required="" id="apellido1" name="apellido1" />
                    </div>
                    <div>
                        <input type="text" placeholder="Segundo apellido" required="" id="apellido2" name="apellido2" />
                    </div>
                    <div>
                        <input type="text" placeholder="Edad" required="" id="edad" name="edad" />
                    </div>
                    <div>
                        <input type="text" placeholder="Teléfono" required="" id="telefono" name="telefono" />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <a href="<?php echo base_url()."index.php"; ?>">Volver atrás</a>
                    </div>
                </form><!-- form -->
            </section><!-- content -->
        </div><!-- container -->
